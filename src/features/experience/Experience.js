...
const Experience = () => {
  return (
    ...
    mx-auto bg-[#FFF8E7] h-[26rem] md:h-70vh' id='work'>
        <p className="flex text-center text-[#34495E] text-[20px] md:text-[32px]" style={{ fontFamily: "'Fira Code', monospace"}}>Page is Under Construction</p>
