...
const ContactMe = () => {
  return (
    ...
    mx-auto bg-[#FFF8E7] text-[#34495E] h-auto' id='contact'>
        ...
        <h2 className='text-xl md:text-3xl md:block hidden font-bold pt-1 md:pt-2 md:pb-1'>Let's Collaborate</h2>
        <h2 className='text-xl md:text-3xl block md:hidden font-bold pt-1 md:pt-2 md:pb-1'>Let's work together</h2>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 w-3/6 md:w-3/6 items-end mb-[5rem]'>
          <div className='grid grid-cols-1 mb-2 md:mb-0 gap-4 w-full md:w-4/6'>
            {socialIcons.map((icon) => (
                <a
                  ...
                  rel='noreferrer'
                  target='_blank'
                  className='flex justify-left items-center hover:translate-x-1 transition transform ease-in-out duration-400 bg-[#FFEBAF] py-1 px-1 mb-2 rounded-sm shadow-md w-full'
                >&nbsp;
          ...
          <div className='flex flex-col'>
            ...
            <button className='flex justify-left items-center hover:translate-x-1 transition transform ease-in-out duration-400 bg-[#FFEBAF] py-1 px-1 mb-2 w-full md:w-4/6 rounded-sm shadow-md'>&nbsp;
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-3 w-full'>
          ...
          <div className='flex flex-wrap px-6'>Developed by
                                ...
                                Made with <span className='text-[#1ABC9C] cursor-pointer'><a href='https://react.dev/' rel='noreferrer' target='_blank'>React</a></span>&nbsp;and&nbsp;<span className='text-[#1ABC9C] cursor-pointer'><a href='https://tailwindcss.com/' rel='noreferrer' target='_blank'>Tailwind CSS</a></span></div>
